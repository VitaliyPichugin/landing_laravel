                ...
                <div class="inner_wrapper">
                    <div class="container">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"> {!! Html::image('assets/img/'.$page->images, '', array('class'=>'img-coub delay-03s animated wow zoomIn')) !!}</div>
                ...
                <div class="container">
                    ...
                    <div class="service_wrapper">
                        @foreach($services as $k=>$service)
                            ...
                            <div class="col-lg-4 mrgTop {{($k%3 > 0) ? 'borderLeft' : ''}}">
                        ...
                        @foreach($peoples as $k => $people)
                            <div class="team_area">
                                <div class="team_box wow fadeInDown delay-0{{ ($k*3 + 3) }}s">
                                    ...
                                    {{Html::image('assets/img/'.$people->img, $people->name)}}
                                    <ul>
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright &copy; 2014,    Template by <a href="http://webthemez.com">WebThemez.com</a>. </span> </div>
    </div>
</footer>